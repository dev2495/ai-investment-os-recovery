...
Verified foundation (updated 2026-07-13): Live Office, System Health, Mission Control, Portfolio Office, Client Folios, Holdings Research, and Ideas are independently mounted production-data workspaces without seed fallback, the 7.40 MB broad poll, or its stale right rail. Research/Ideas adds 46 long-term theses, filing/news/special-situation monitoring, committee state, generated ideas, discovery candidates, durable dossiers, outputs, and approval-safe strategy intake through a 319 KB/0.60 s scoped read. Portfolio/Clients retains 3 clients, 71 positions, books/exposure, reconciliations, and approval-gated holding staging. Mission retains Charlie chat, durable delegation, approvals, widgets, workers, and execution/provider gates. The office evidence drawer remains live for mailbox work. Phase 8 remains partial until Trading, Quant, Risk, and Reports are scoped, deep decision/source drawers and workflow controls are complete, and accessibility/performance gates pass.
