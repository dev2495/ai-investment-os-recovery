...
- The Command Center and Live Office world toggle is live. Only Trading, Quant, Risk, and Reports retain `/api/snapshot`; Mission Control, System Health, Portfolio, Clients, Research, and Ideas use scoped reads, while Live Office uses `/api/office/snapshot`.
...
- Performance measurement: bounded `/api/snapshot` took 9.20 seconds and returned 7.40 MB. Delivered scoped reads: office 242 KB/105 ms, system about 83 KB, Mission 204 KB/0.27 s, Portfolio 196 KB/0.30 s, and Research/Ideas 319 KB/0.60 s. Next: Trading, Quant, Risk, and Reports.
