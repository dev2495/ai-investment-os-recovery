...
- Performance measurement: bounded `/api/snapshot` took 9.20 seconds and returned 7.40 MB. Reports now reads 605 KB in 0.23 seconds; every route is scoped. Next: dead-code removal, deep evidence/action workflows, and production gates.
