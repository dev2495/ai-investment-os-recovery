...
- Performance measurement: bounded `/api/snapshot` took 9.20 seconds and returned 7.40 MB on 2026-07-10. The delivered `/api/office/snapshot` took 105 ms and returned 242 KB while preserving 36 agents, 10 rooms, 24 activity rows, 50 messages, and 6 committee matters. Next: scoped Command Center workspace reads, while keeping deep evidence available on demand.
