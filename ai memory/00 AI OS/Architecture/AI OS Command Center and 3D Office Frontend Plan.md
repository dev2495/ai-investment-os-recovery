...
- Verified 2026-07-15: six Bloomberg-style department terminals are live for approvals, agents, committees, capital allocation, treasury/macro, and model runtime. They use bounded scoped endpoints, real warehouse rows, explicit freshness, evidence drawers, a global execution lock, and no seed fallback. The workspace manager persists theme, density, columns, module order, hidden modules, and widget layout through audited APIs and MCP. The live Agent Office now renders 49 active profiles across 11 departments. The Research workspace includes source-backed papers and paper-derived hypotheses; Trading exposes six approval-gated advanced chart templates. Fourteen functional browser cases and all 23 WCAG A/AA cases pass; final desktop/mobile artifacts are retained externally. Evidence: [[2026-07-15-terminal-agent-research-foundation-v1]].
...
- The office maps 49 configured agents, 10 live rooms, live task/message state, and committee queues from Postgres with no client-side seed fallback.
...
- Verified 2026-07-15: the operating foundation now has 19 addressable Command Center workspaces, 15 source-backed department desks, a persistent audited widget rail, and addressable profiles for all 95 active employees with work history and cost/quality evidence. The Committee Room supports real packets, independent sealed positions, quorum, challenge discussion, chair synthesis, minutes/dissent, separate human decisions, and follow-up tasks for Strategy, Long-Term, and Special Situations. TradingView production acceptance covers formula charts plus technical and fundamental study stacks; four-pane options layouts remain partial. The full browser matrix contains 93 unique desktop/mobile, workflow, accessibility, and WebGL cases and was passed in bounded shards. Final 3D art, avatar hit testing, and chronological playback remain the later refinement pass. Evidence: [[2026-07-15-department-terminals-tradingview-and-committee-operations-v1]].
