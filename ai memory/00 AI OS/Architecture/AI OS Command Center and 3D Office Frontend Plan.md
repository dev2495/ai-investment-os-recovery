...
- The Command Center and Live Office world toggle is live. Legacy Research, Ideas, Trading, Quant, Risk, and Reports workspaces retain `/api/snapshot`; Mission Control, System Health, Portfolio Office, and Client Folios use scoped read models, while Live Office uses `/api/office/snapshot`.
...
- Performance measurement: bounded `/api/snapshot` took 9.20 seconds and returned 7.40 MB on 2026-07-10. Delivered scoped reads: office 242 KB/105 ms, system health about 83 KB, Mission Control 204 KB/0.27 s, and Portfolio Office 196 KB/0.30 s. Next: scoped Research, Ideas, Trading, Quant, Risk, and Reports reads while keeping deep evidence available on demand.
