# AI Investment OS - Institutional Build Checklist v4.0

Date: 2026-07-06
Canonical blueprint: [[AI Investment OS - Institutional Master Blueprint v4.0]]
Purpose: execution tracker for building the full AI hedge fund operating system.
...
- [ ] Add production data vs test data separation policy.
- [ ] Add investment disclaimer and human-control policy.

## 1. Foundation Runtime

- [x] Runtime workspace on external SSD.
- [x] Docker available and forced to external SSD storage.
...
- [~] Local model/Ollama manually available; 24/7 reliability still open.
...
- [x] TradingView MCP/controller CDP connection verified; production chart actions still open.
...
- [x] Complete NSE/BSE filing collector and PDF extraction foundation.
- [x] Complete Special Situations inbox and event memo workflow.
- [x] Add special-situation spread/decision controls.
- [x] Add event-symbol quote refresh for special-situation spreads.
- [x] Build Long-Term thesis schema and memo template.
- [x] Build source freshness and reconciliation dashboard.
- [x] Add scheduled stale-source alerts.
- [x] Build TradingView CDP/controller connection once browser is launched correctly.
