...
- [~] Command Center shell extraction from monolithic `App.tsx` with no behavior loss. Verified 2026-07-13: Live Office and System Health now mount as independent workspace components; direct System Health routing suppresses both the broad Command Center snapshot lifecycle and its stale right rail. Remaining Command Center workspace modules still need extraction. Evidence: [[2026-07-13-system-health-v2-and-docker-runtime-recovery]].
