...
- [~] Live snapshot/API contract for office, committee, chat, message, widget, portfolio, strategy, research, risk, and system surfaces. Evidence: `ai-office-ui/src/api/live.ts`, broad `/api/snapshot`, and scoped `/api/office/snapshot`, `/api/system-health/snapshot`, `/api/mission-control/snapshot`, and `/api/portfolio-office/snapshot`. Research, idea, trading, quant, risk, and report workspaces still require scoped contracts.
...
- [~] Command Center shell extraction from monolithic `App.tsx` with no behavior loss. Verified 2026-07-13: Live Office, System Health, Mission Control, Portfolio Office, and Client Folios now mount as independent workspace components. These direct routes suppress both the broad Command Center snapshot lifecycle and its stale right rail. Research, Ideas, Trading, Quant, Risk, and Reports still need extraction. Evidence: [[2026-07-13-system-health-v2-and-docker-runtime-recovery]], [[2026-07-13-mission-control-v2-scoped-workspace]], and [[2026-07-13-portfolio-office-and-client-folios-v2]].
...
- [~] Focused workspace snapshot profile and payload budget. Verified 2026-07-13: bounded `/api/snapshot` remains about 7.6 MB/9.7 s; `/api/office/snapshot` is 242 KB/105 ms; `/api/system-health/snapshot` is about 83 KB/0.12-0.75 s with 209 rows/16 queries; `/api/mission-control/snapshot` is about 204 KB/0.27 s with 167 rows/14 queries; `/api/portfolio-office/snapshot` is about 196 KB/0.30 s with 313 rows/15 queries. Live Office, System Health, Mission Control, Portfolio Office, and Client Folios no longer require the broad poll. Evidence: [[2026-07-13-system-health-v2-and-docker-runtime-recovery]], [[2026-07-13-mission-control-v2-scoped-workspace]], and [[2026-07-13-portfolio-office-and-client-folios-v2]].
