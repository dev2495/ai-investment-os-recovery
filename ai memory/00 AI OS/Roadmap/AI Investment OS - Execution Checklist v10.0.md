...
- [~] Command Center shell extraction from monolithic `App.tsx` with no behavior loss. Verified 2026-07-13: Live Office, System Health, Mission Control, Portfolio Office, Client Folios, Holdings Research, and Ideas now mount as independent components without the broad poll or stale right rail. Trading, Quant, Risk, and Reports still need extraction. Evidence: [[2026-07-13-system-health-v2-and-docker-runtime-recovery]], [[2026-07-13-mission-control-v2-scoped-workspace]], [[2026-07-13-portfolio-office-and-client-folios-v2]], and [[2026-07-13-holdings-research-and-ideas-v2]].
...
- [~] Focused workspace snapshot profile and payload budget. Verified 2026-07-13: broad `/api/snapshot` remains about 7.6 MB/9.7 s; scoped reads are office 242 KB/105 ms, system 83 KB/0.12-0.75 s, Mission 204 KB/0.27 s, Portfolio 196 KB/0.30 s, and Research/Ideas 319 KB/0.60 s for 322 rows/15 queries. Only Trading, Quant, Risk, and Reports retain the broad poll. Evidence: [[2026-07-13-holdings-research-and-ideas-v2]].
