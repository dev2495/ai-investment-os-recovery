...
> Current checklist and all 12 demonstration statuses: [7 September final acceptance ledger](FINAL_ACCEPTANCE_2026-09-07.md). Historical items below are retained for traceability.
