...
INSERT INTO agent.local_model_registry (
    ...
    'phi4-mini:3.8b', 'ollama', 'light', ARRAY['imac'], 8192,
    ...
    'Always-on iMac assistant candidate. It may converse, intake tasks, select allowlisted tools, and summarize supplied evidence. It has no calculation, research-authority, capital, approval, broker, or execution authority.',
    '[{"source":"https://ollama.com/library/phi4-mini","model_tag":"phi4-mini:3.8b","expected_disk_gb":2.5,"license":"MIT","eval_required":"conversation_v1","raw_prompt_stored":false,"live_execution_allowed":false}]'::jsonb
)
...
INSERT INTO agent.model_routes (
    ...
    'imac_basic_assistant_phi', 'conversation_and_governed_tool_intake',
    'ollama', 'phi4-mini:3.8b', 'openrouter', 'z-ai/glm-4.7-flash', 'local',
...
INSERT INTO agent.model_endpoints (
    ...
    'ollama_phi4_mini_3_8b_imac', 'iMac Phi-4 Mini always-on assistant',
    'ollama', 'phi4-mini:3.8b', 'imac_basic_assistant_phi', 'local',
    ...
    'Candidate until conversation_v1 passes for the exact installed digest. Concurrency one and 8K context.',
...
WHERE endpoint.endpoint_key='ollama_phi4_mini_3_8b_imac'
  AND registry.model_name='phi4-mini:3.8b'
