...
INSERT INTO agent.local_model_registry (
    ...
    'granite4:3b', 'ollama', 'light', ARRAY['imac'], 8192,
    ...
    '[{"source":"https://registry.ollama.com/library/granite4","model_tag":"granite4:3b","expected_disk_gb":2.1,"license":"Apache-2.0","eval_required":"conversation_v1","raw_prompt_stored":false,"live_execution_allowed":false}]'::jsonb
)
...
INSERT INTO agent.model_routes (
    ...
    'imac_basic_assistant', 'conversation_and_governed_tool_intake',
    'ollama', 'granite4:3b', 'openrouter', 'z-ai/glm-4.7-flash', 'local',
...
INSERT INTO agent.model_endpoints (
    ...
    'ollama_granite4_3b_imac', 'iMac Granite 4 Micro always-on assistant',
    'ollama', 'granite4:3b', 'imac_basic_assistant', 'local',
    'http://127.0.0.1:11434', 'imac_m1_8gb', 'configured', 8192, 2.1,
