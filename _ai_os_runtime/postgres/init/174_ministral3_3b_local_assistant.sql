...
INSERT INTO agent.local_model_registry (
    ...
    'ministral-3:3b-instruct-2512-q4_K_M', 'ollama', 'light', ARRAY['imac'], 8192,
    NULL, 'conversation_v1', 'candidate',
    ARRAY['conversation','task_intake','tool_selection','evidence_bound_summary','structured_output'],
    '/Volumes/Devarsh SSD/AI OS Data/ollama/models',
    'Ministral 3 3B Q4 candidate for the always-on natural conversation and governed tool-intake fallback. It has no calculation, research-authority, approval, capital, broker, or execution authority and is not assignable before exact-digest conversation_v1 promotion.',
    '[{"source":"https://ollama.com/library/ministral-3:3b-instruct-2512-q4_K_M","license":"Apache-2.0","architecture":"ministral3","ollama_tag":"ministral-3:3b-instruct-2512-q4_K_M","quantization":"Q4_K_M","expected_disk_gb":3.0,"minimum_ollama_version":"0.13.1","runtime_compatibility_probe_required":true,"eval_required":"conversation_v1","raw_prompt_stored":false,"capital_action_allowed":false,"live_execution_allowed":false}]'::jsonb
)
...
INSERT INTO agent.model_routes (
    ...
    'ministral3_3b_local_assistant', 'conversation_and_governed_tool_intake',
    'ollama', 'ministral-3:3b-instruct-2512-q4_K_M',
    'openrouter', 'z-ai/glm-4.7-flash', 'local',
    'Disabled until the exact installed digest passes conversation_v1 with zero hard failures and acceptable iMac latency. Deterministic tools remain authoritative.',
    false
)
...
INSERT INTO agent.model_endpoints (
    ...
    'ollama_ministral3_3b_q4_imac', 'iMac Ministral 3 3B Q4 candidate',
    'ollama', 'ministral-3:3b-instruct-2512-q4_K_M', 'ministral3_3b_local_assistant', 'local',
    'http://127.0.0.1:11434', 'imac_m1_8gb', 'configured', 8192, 3.0,
    'local', ARRAY['text','conversation','tools','structured_output'], false,
    'unchecked', 'AI Runtime Engineer',
    'Candidate only. Requires Ollama 0.13.1 or later, exact digest capture, conversation_v1 pass, zero hard failures, and median latency within 30 seconds before activation.',
    '{"num_parallel":1,"keep_alive":"10m","context_tokens":8192,"max_output_tokens":512,"raw_prompt_stored":false,"capital_action_allowed":false,"live_execution_allowed":false}'::jsonb
)
