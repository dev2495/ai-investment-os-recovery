...
sync_launchd_payload() {
  ...
  cp -f "${RUNTIME_ROOT}/api/agent_os_policy.py" "${AIOS_SERVICE_DIR}/api/agent_os_policy.py"
  cp -f "${RUNTIME_ROOT}/api/agent_collaboration.py" "${AIOS_SERVICE_DIR}/api/agent_collaboration.py"
  cp -f "${RUNTIME_ROOT}/api/agent_charlie.py" "${AIOS_SERVICE_DIR}/api/agent_charlie.py"
  cp -f "${RUNTIME_ROOT}/api/agent_model_fabric.py" "${AIOS_SERVICE_DIR}/api/agent_model_fabric.py"
  cp -f "${RUNTIME_ROOT}/api/doctor_runtime.py" "${AIOS_SERVICE_DIR}/api/doctor_runtime.py"
  cp -f "${RUNTIME_ROOT}/api/routine_runtime.py" "${AIOS_SERVICE_DIR}/api/routine_runtime.py"
  ...
  cp -f "${RUNTIME_ROOT}/scripts/ai_os_doctor.py" "${AIOS_SERVICE_DIR}/scripts/ai_os_doctor.py"
  cp -f "${RUNTIME_ROOT}/scripts/run_ai_os_routine.py" "${AIOS_SERVICE_DIR}/scripts/run_ai_os_routine.py"
  cp -f "${RUNTIME_ROOT}/scripts/index_obsidian_vault.py" "${AIOS_SERVICE_DIR}/scripts/index_obsidian_vault.py"
  cp -f "${RUNTIME_ROOT}/scripts/runtime_executables.py" "${AIOS_SERVICE_DIR}/scripts/runtime_executables.py"
