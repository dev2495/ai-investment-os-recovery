...
const workspaceIds: WorkspaceId[] = ["command", "approvals", "agents", "departments", "committees", "governance", "portfolio", "clients", "tactical", "research", "ideas", "arsenal", "trading", "quant", "risk", "capital", "treasury", "models", "reports", "system"];
