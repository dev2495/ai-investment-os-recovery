...
const workspaceIds: WorkspaceId[] = ["command", "approvals", "agents", "committees", "portfolio", "clients", "research", "ideas", "arsenal", "trading", "quant", "risk", "capital", "treasury", "models", "reports", "system"];
