...
export AI_OS_ENABLE_TRADINGVIEW_QUOTE_REFRESH="${AI_OS_ENABLE_TRADINGVIEW_QUOTE_REFRESH:-0}"
export AI_OS_TRADINGVIEW_QUOTE_REFRESH_INTERVAL_SECONDS="${AI_OS_TRADINGVIEW_QUOTE_REFRESH_INTERVAL_SECONDS:-900}"
export AI_OS_TRADINGVIEW_QUOTE_REFRESH_TIMEOUT_SECONDS="${AI_OS_TRADINGVIEW_QUOTE_REFRESH_TIMEOUT_SECONDS:-120}"
export AI_OS_TRADINGVIEW_QUOTE_REFRESH_LIMIT="${AI_OS_TRADINGVIEW_QUOTE_REFRESH_LIMIT:-100}"
...
exec python3 -u scripts/run_agent_message_daemon.py \
  ...
  --tradingview-quote-refresh-interval "${AI_OS_TRADINGVIEW_QUOTE_REFRESH_INTERVAL_SECONDS}" \
  --tradingview-quote-refresh-timeout "${AI_OS_TRADINGVIEW_QUOTE_REFRESH_TIMEOUT_SECONDS}" \
