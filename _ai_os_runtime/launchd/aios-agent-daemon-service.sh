...
export AI_OS_ENABLE_PAPER_MONITOR_EVALUATION="${AI_OS_ENABLE_PAPER_MONITOR_EVALUATION:-1}"
export AI_OS_PAPER_MONITOR_INTERVAL_SECONDS="${AI_OS_PAPER_MONITOR_INTERVAL_SECONDS:-60}"
export AI_OS_PAPER_MONITOR_TIMEOUT_SECONDS="${AI_OS_PAPER_MONITOR_TIMEOUT_SECONDS:-120}"
export AI_OS_PAPER_MONITOR_LIMIT="${AI_OS_PAPER_MONITOR_LIMIT:-20}"
...
exec python3 -u scripts/run_agent_message_daemon.py \
  ...
  --paper-monitor-interval "${AI_OS_PAPER_MONITOR_INTERVAL_SECONDS}" \
  --paper-monitor-timeout "${AI_OS_PAPER_MONITOR_TIMEOUT_SECONDS}" \
  --paper-monitor-limit "${AI_OS_PAPER_MONITOR_LIMIT}" \
